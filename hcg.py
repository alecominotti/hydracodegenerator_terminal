...
def setWebDriver():
    ...
    if runningOnLinux:
        driverpath=r"resources/chromedriver"
    elif runningOnMac:
        driverpath=r"path/to/mac/driver"
    elif runningOnWindows:
        driverpath=r"resources/chromedriver.exe"
    else:
        print(RED+"ERROR: " + WHITE + "Your operating system is not compatible.")
        exit(1)
